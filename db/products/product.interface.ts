...
import IRestockData from "../../shared/DTO/products/interface/RestockData.interface";
...
export default interface IProduct extends IProductID, IProductName, IUnitPrice, IQuantity, IRestockData, IExpirationDate{
